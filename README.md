...
Проект представляет собой SPA (Single Page Application), реализующее сложную таблицу данных с древовидной структурой (Tree Table). Приложение разработано на **React 19** без использования сторонних UI-библиотек (Material UI, AntD и т.д.), все компоненты написаны с нуля с использованием **Tailwind CSS**.
